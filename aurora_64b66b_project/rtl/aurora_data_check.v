...
//              Checks received payload data against expected 32-bit
//              incrementing pattern. Reports errors and statistics.
//////////////////////////////////////////////////////////////////////////////

module aurora_data_check (
    input  wire         clk,
    input  wire         rst,
    // Input from RX module
    ...
    reg        first_beat;        // Track first beat to initialize expected
    ...
    always @(posedge clk) begin
        if (rst) begin
            ...
            if (rx_sof) begin
                // Start of new frame: synchronize to received data
                expected_counter <= rx_data[31:0];
                first_beat       <= 1'b0;
            ...
            // Update expected counter for next beat
            if (!rx_sof)
